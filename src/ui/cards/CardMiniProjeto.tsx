...
const CardMiniProjetos: React.FC<miniCardProjetosProps> = ({ miniProjeto }) => {
  ...
  return (
    <div
      className="flex items-center gap-4 w-[41.75rem] justify-between h-20 rounded-[10px] bg-[#4568BE] border-2 border-[#1A326E] cursor-pointer px-6 py-4 text-white font-medium"
      onClick={handleClick}
    >
